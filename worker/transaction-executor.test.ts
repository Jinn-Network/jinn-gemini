...
describe('SafeExecutor', () => {
  ...
  describe('Payload Validation', () => {
    it('should validate required payload fields', () => {
      ...
      expect(() => executor.validatePayload(invalidPayload)).toThrow('Invalid payload');
    });
    ...
    it('should validate address format', () => {
      ...
      expect(() => executor.validatePayload(invalidPayload)).toThrow('Invalid address format');
    });
    ...
    it('should validate data hex format', () => {
      ...
      expect(() => executor.validatePayload(invalidPayload)).toThrow('Invalid data format');
    });
    ...
    it('should reject non-zero value transactions', () => {
      ...
      expect(() => executor.validatePayload(payloadWithValue)).toThrow('Non-zero value transactions not allowed');
    });
  });
  ...
  describe('Allowlist Enforcement', () => {
    it('should reject contracts not in allowlist', () => {
      ...
      expect(() => executor.validateAllowlist(payload, 8453)).toThrow('Contract not in allowlist');
    });
    ...
    it('should reject function selectors not in allowlist', () => {
      ...
      expect(() => executor.validateAllowlist(payload, 8453)).toThrow('Function selector not allowed');
    });
    ...
    it('should handle chain mismatch', () => {
      ...
      expect(() => executor.validateAllowlist(payload, 1)).toThrow('Chain not supported');
    });
  });
