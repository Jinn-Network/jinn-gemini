...
export const SERVICE_CONSTANTS = {
  ...
  DEFAULT_SERVICE_BOND_WEI: "10000000000000000", // 0.01 ETH in wei
  
  // Fund requirements (wei as integers for middleware)
  DEFAULT_AGENT_FUNDING_WEI: 500000000000000, // 0.0005 ETH for gas
  DEFAULT_SAFE_FUNDING_WEI: 500000000000000,   // 0.0005 ETH for gas
  
  // OLAS token requirements (Base mainnet: 0x54330d28ca3357F294334BDC454a032e7f353416)
  DEFAULT_AGENT_OLAS_WEI: "50000000000000000000", // 50 OLAS
  DEFAULT_SAFE_OLAS_WEI: "50000000000000000000",   // 50 OLAS
  
  // Real, verified IPFS hash from olas-operate-app (Trader Agent template)
  DEFAULT_SERVICE_HASH: "bafybeiardecju3sygh7hwuywka2bgjinbr7vrzob4mpdrookyfsbdmoq2m", // Base-compatible service package
  
  // Staking configuration
  DEFAULT_STAKING_PROGRAM_ID: "agents_fun_1", // Base mainnet staking
 ...
 * JINN-194: Now uses real IPFS hash, supported chain, and integer fund requirements
 */
export function createDefaultServiceConfig(overrides: Partial<ServiceConfigTemplate> = {}): ServiceConfigTemplate {
  ...
  return {
    ...
    hash: SERVICE_CONSTANTS.DEFAULT_SERVICE_HASH, // Real working hash
      ...
      [homeChain]: {
        ...
        fund_requirements: {
          "0x0000000000000000000000000000000000000000": {
            agent: SERVICE_CONSTANTS.DEFAULT_AGENT_FUNDING_WEI, // 0.0005 ETH for gas
            safe: SERVICE_CONSTANTS.DEFAULT_SAFE_FUNDING_WEI    // 0.0005 ETH for gas
          },
          "0x54330d28ca3357F294334BDC454a032e7f353416": { // OLAS token on Base
            agent: parseInt(SERVICE_CONSTANTS.DEFAULT_AGENT_OLAS_WEI), // 50 OLAS
            safe: parseInt(SERVICE_CONSTANTS.DEFAULT_SAFE_OLAS_WEI)    // 50 OLAS
          }
        }
      }
    },
