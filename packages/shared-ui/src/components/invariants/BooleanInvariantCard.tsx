    ...
    return (
      <div className={cn('flex items-center justify-between gap-4 py-2', className)}>
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className={cn('text-xs px-1.5 py-0.5 rounded border', invariantTypeBadgeColors.BOOLEAN)}>
            BOOLEAN
          </span>
          <span className="text-sm truncate">{invariant.condition}</span>
        </div>
    ...
    <div className={cn('p-4 rounded-lg border bg-card', className)}>
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm font-medium mb-2">{invariant.condition}</p>
