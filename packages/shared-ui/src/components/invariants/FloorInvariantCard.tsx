    ...
    return (
      <div className={cn('flex items-center justify-between gap-4 py-2', className)}>
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className={cn('text-xs px-1.5 py-0.5 rounded border', invariantTypeBadgeColors.FLOOR)}>
            FLOOR
          </span>
          <span className="text-sm truncate">{invariant.metric} ≥ {invariant.min}</span>
        </div>
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="mb-2">
            ...
            <span className="text-muted-foreground"> must be at least </span>
            <span className="text-sm font-semibold text-purple-500">{invariant.min}</span>
          </div>
