...
// Use process.cwd() to reliably find the .env file at the project root.
...
if (!supabaseUrl || !supabaseKey) {
  throw new Error(`Supabase URL and key must be provided in .env file. Looked for .env at: ${envPath}`);
}
