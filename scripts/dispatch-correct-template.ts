...
console.log("Check: curl -s -X POST 'https://jinn-gemini-production.up.railway.app/graphql' -H 'Content-Type: application/json' -d '{\"query\":\"{ jobTemplates(where: { name_contains: \\\"v2\\\" }, limit: 5) { items { id name blueprint } } }\"}' | jq");
