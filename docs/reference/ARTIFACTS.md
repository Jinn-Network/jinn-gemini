...
| `SITUATION` | Job context for memory/recognition | Worker (automatic) |
| `MEMORY` | Learnings from recognition/reflection phases | Worker (automatic) |
...
- `SITUATION` - Always created
- `MEMORY` - Created during reflection phase
...
```bash
yarn inspect-workstream <id> --format=summary
...
- Memory architecture: `docs/documentation/MEMORY_ARCHITECTURE.md`
- IPFS delivery: `docs/documentation/WORKER_INTERNALS.md`
