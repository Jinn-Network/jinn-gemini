...
**Workstream overview:**
```bash
yarn inspect-workstream <workstream-id> --format=summary
```
...
- Dispatch types: `docs/reference/DISPATCH_TYPES.md`
- Job terminology: `docs/documentation/JOB_TERMINOLOGY.md`
